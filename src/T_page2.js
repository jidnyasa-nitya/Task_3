    ...
    <div>
      <div className="rectangle">
        ...
        <div className="outer">
          ...
          <div>
            <div id="display">
              <p id="Tlbl" style={{ font: "24px Lato" }}>
                Timings
              </p>
              <Page5 />
              {bolin ? (
                <div>
                  <br />
                  <button id="addtime" onClick={handleclick}>
                    <IoAddCircleOutline Add-Timing color="#0078D4" />
                    <u>Add Timings</u>
                  </button>
                </div>
              ) : (
